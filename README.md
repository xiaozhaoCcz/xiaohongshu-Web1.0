...
- 因为上一个项目白嫖怪太多，这个项目下载不会有数据库文件，需要数据库文件加我微信或qq，会收取50元的费用。当然你可以在yanhuo_dev这个项目上的数据源进行改造，这两个项目的数据源都差不多。
- 如果想自己做一个仿小红书项目，我这里也提供了免费的前端仿小红书源码 https://gitee.com/xzjsccz/xiaohongshu
